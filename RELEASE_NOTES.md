...
- Adds a 27-word quaternary length-8 code with exact covering radius 4.
- Proves `K_4(8,4) <= 27`, improving the audited upper bound 28 by one.
- Adds two independent exhaustive Python verifiers.
- Adds a separately written direct-distance C++ verifier.
